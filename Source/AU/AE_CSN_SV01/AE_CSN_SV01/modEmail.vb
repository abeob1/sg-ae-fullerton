...
Module modEmail
    ...
    Public Function SendEmail_INFOCARE(ByVal sBody As String, ByRef sErrDesc As String) As Long

        Dim sFuncName As String = "SendEmail_INFOCARE"
    ...
    Public Sub EmailTemplate_Error()
        ...
        Try
            ...
            sBody = sBody & " Dear Valued Customer,<br /><br /> Infocare Interface program had encountered the problem based on the following information. <br /><br />"
            ...
            If SendEmail_INFOCARE(sBody, sErrDesc) <> RTN_SUCCESS Then Throw New ArgumentException(sErrDesc)
    ...
    Public Sub EmailTemplate_Success()
        ...
        Try
            ...
            sBody = sBody & "<div align=left style='font-size:10.0pt;font-family:Arial'>"
            sBody = sBody & " Dear Valued Customer,<br /><br /> INFOCARE Interface program had Successfully uploaded the files into SAP. <br /><br />"
