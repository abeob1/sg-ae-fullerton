...
Namespace AE_FHG_AO01
    Module modMain
        ...
        Public p_oDtSyncLogOUSR As DataTable = Nothing

        Public p_FrmType As Integer
        Public p_iCOACount As Integer = 0
        Public p_iUserCount As Integer = 0
        ...
        Sub Main(ByVal args() As String)
            ...
            Try
                ...
                p_oDtSyncLogCOA = CreateDataTable("Entity", "GL Code", "GL Name", "Status", "Error Message")

                If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Calling CreateDataTable() for User", sFuncName)
                p_oDtSyncLogOUSR = CreateDataTable("Entity", "User Code", "User Name", "Status", "Error Message")
