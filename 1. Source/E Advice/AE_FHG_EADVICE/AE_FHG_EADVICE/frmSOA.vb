...
Public Class frmSOA
                        ...
                        If Convert.ToBoolean(Dgv_BPList.Rows(imjs).Cells(0).Value) = True Then
                            ...
                            If sEmail <> String.Empty Then
                                ...
                                If oDS1.Tables(0).Rows.Count > 0 Then
                                    ...
                                    If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Calling function ExportToPDF() ", sFuncName)
                                    If ExportToPDF(sCardcode, sCardcode, dDateCon, sTargetFileName, sRptFileName, sErrdesc) <> RTN_SUCCESS Then
                                    ...
                                    Me.Refresh()
                                    If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Calling function SendEmailNotification() " & sCardName, sFuncName)
                                    ''If SendEmailNotification(sTargetFileName, "sahayar@abeo-electra.com", sBody, sSubject, sErrdesc) <> RTN_SUCCESS Then Throw New ArgumentException(sErrdesc)
                                    If SendEmailNotification(sTargetFileName, sEmail, sBody, sSubject, sErrdesc) <> RTN_SUCCESS Then Throw New ArgumentException(sErrdesc)
    ...
    Private Sub SCompany_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles SCompany.SelectedIndexChanged
        sCompanyName = Me.SCompany.SelectedItem.ToString
    End Sub
End Class
