Module modPDF
    ...
    Public Function ExportToPDF(ByVal sCardCodeFrom As String, _
        ...
        Dim intCounter1 As Integer
        Dim iCount As Integer
        Dim iSubRParaCount As Integer        'Crystal Report's report document object

        Dim objReport As New CrystalDecisions.CrystalReports.Engine.ReportDocument
        'object of table Log on info of Crystal report
        If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("1", sFuncName)
        Dim crtableLogoninfo As New CrystalDecisions.Shared.TableLogOnInfo
        If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("1.5", sFuncName)
        Dim crConnectionInfo As New CrystalDecisions.Shared.ConnectionInfo
        ...
        Try
            ...
            CrDiskFileDestinationOptions.DiskFileName = sTargetFileName '"C:\Users\sri\Desktop\Abeo\SOA.pdf" '
            CrExportOptions = objReport.ExportOptions
            With CrExportOptions
                'Set the destination to a disk file 
                .ExportDestinationType = CrystalDecisions.Shared.ExportDestinationType.DiskFile
    ...
    Public Function ExportToPDF_New(ByVal iDocEntry As Integer, _
