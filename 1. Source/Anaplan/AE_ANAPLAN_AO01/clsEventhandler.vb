Public Class clsEventhandler
    ...
    Sub AddMenuItems()
        ...
        Try
            ...
            'Create s sub menu
            oCreationPackage.Type = SAPbouiCOM.BoMenuType.mt_STRING
            oCreationPackage.UniqueID = "GTB"
            oCreationPackage.String = "Generate trial Balance"

            If Not p_oSBOApplication.Menus.Exists("GTB") Then
                oMenus.AddEx(oCreationPackage)
            End If
        ...
        Try
            ...
            If pVal.BeforeAction = False Then
                Select Case pVal.MenuUID
                    Case "GTB"
                        GTB_SBO_MenuEvent(pVal, BubbleEvent)
                End Select
            End If
            ...
            Select Case pVal.FormUID
                Case "GTB"
                    If Not (pVal.EventType = SAPbouiCOM.BoEventTypes.et_FORM_UNLOAD Or pVal.EventType = SAPbouiCOM.BoEventTypes.et_FORM_CLOSE) Then
                        ...
                        GTB_SBO_ItemEvent(FormUID, pVal, BubbleEvent, oForm)
                        Exit Sub
                    End If
            End Select
        Catch exc As Exception
