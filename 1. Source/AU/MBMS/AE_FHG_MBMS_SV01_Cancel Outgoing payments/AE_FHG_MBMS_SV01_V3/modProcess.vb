...
Module modProcess
    ...
    Public Sub Start()
        ...
        Try
            ...
            WriteToStatusScreen(False, "=============================== Cancelling Batch No:: " & CancelDocuments.txtBatchNo.Text & "  ===========================")
...
#Region "AP"
    ...
    Private Function CancelAPCreditNotes(ByRef sErrdesc As String) As Long
        ...
        Try
            ...
            Dim sSQL As String = "SELECT T0.""DocNum"",T0.""DocEntry"" FROM ORPC T0 WHERE T0.""ImportEnt""='" & CancelDocuments.txtBatchNo.Text & "' AND ""CANCELED""='N'"
    ...
    Private Function CancelAPInvoices(ByRef sErrdesc As String) As Long
        ...
        Try
            ...
            Dim sSQL As String = "SELECT T0.""DocNum"",T0.""DocEntry"" FROM OPCH T0 WHERE T0.""ImportEnt""='" & CancelDocuments.txtBatchNo.Text & "' AND ""CANCELED""='N'"
...
#Region "AR"
    ...
    Private Function CancelARCreditNotes(ByRef sErrdesc As String) As Long
        ...
        Try
            ...
            Dim sSQL As String = "SELECT T0.""DocNum"",T0.""DocEntry"" FROM ORIN T0 WHERE T0.""ImportEnt""='" & CancelDocuments.txtBatchNo.Text & "' AND ""CANCELED""='N'"
    ...
    Private Function CancelARInvoices(ByRef sErrdesc As String) As Long
        ...
        Try
            ...
            Dim sSQL As String = "SELECT T0.""DocNum"",T0.""DocEntry"" FROM OINV T0 WHERE T0.""ImportEnt""='" & CancelDocuments.txtBatchNo.Text & "' AND ""CANCELED""='N'"
