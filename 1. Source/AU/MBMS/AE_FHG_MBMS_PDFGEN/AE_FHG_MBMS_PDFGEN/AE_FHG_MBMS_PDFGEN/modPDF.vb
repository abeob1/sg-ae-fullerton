Module modPDF
    ...
    Public Function ExportToPDF(ByVal iDocEntry As Integer, _
        ...
        Try
            ...
            sRptFileName = p_oCompDef.sReportsPath & "\" & sReportFileName
            ...
            'Export to PDF
            If sCardCode = String.Empty Then
                sTargetFile = p_oCompDef.sReportPDFPath & "\" & sType & "_" & iDocNum & ".pdf"
            Else
                sTargetFile = p_oCompDef.sReportPDFPath & "\" & sType & "_" & sCardCode & "_" & iDocNum & ".pdf"
            End If
