...
Module modCommon
    ...
    Public TaxInvoice_F As New frmTaxInvoice
    Public Creditnote_F As New frmCreditNote
    ...
    Public Sub FrmTaxInvoice_Show()
        Try
            Dim bCloseApp As Boolean = False
            TaxInvoice_F = New frmTaxInvoice
            TaxInvoice_F.MdiParent = frmEadvice
            TaxInvoice_F.Show()
            bCloseApp = (SOA_F.DialogResult = DialogResult.Abort)
            TaxInvoice_F = Nothing
    ...
    Public Sub FrmCreditNote_Show()
        Try
            Dim bCloseApp As Boolean = False
            Creditnote_F = New frmCreditNote
            Creditnote_F.MdiParent = frmEadvice
            Creditnote_F.Show()
            bCloseApp = (SOA_F.DialogResult = DialogResult.Abort)
            Creditnote_F = Nothing
