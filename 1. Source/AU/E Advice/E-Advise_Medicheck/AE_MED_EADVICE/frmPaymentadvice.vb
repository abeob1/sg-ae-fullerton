...
Public Class frmPaymentadvice
                    ...
                    If oDS.Tables(0).Rows.Count > 0 Then
                        For Each row As DataRow In oDS.Tables(0).Rows
                            If row.Item("E_Mail").ToString <> String.Empty Then
                                ...
                                sBody = sBody & " Dear Sir/Madam,<br /><br /> Account Code: " & row.Item("CardCode").ToString.Trim & "<br /><br /><br />"
                                ...
                                sBody = sBody & " If you have any queries please contact us on (07) 4046 8600 or email accounts@cairnshealth.com.au <br /><br />"
                                sBody = sBody & "<br/><br/>"
                                sBody = sBody & "<br/><br/>"
                                sBody = sBody & "<br/><br/>"
                                sBody = sBody & "Gayle Baxter |Accounts| Central Plaza Doctors/Smithfield Central Doctors | 60 McLeod St Cairns QLD 4870 <br/>"
                                sBody = sBody & "|Ph: (07) 4046 8600| Fax: (07) 4046 8699| accounts@cairnshealth.com.au <br/><br/>"
                                ...
                                sSubject = "Accounts payable remittances from Medicheck (" & sCompanyName & ")"
    ...
    Private Sub btnPaymentCFL_Click(sender As System.Object, e As System.EventArgs) Handles btnPaymentCFL.Click
        Dim sErrdesc As String = String.Empty
        If Not Me.SCompany.Text = "--Select Company-- " Then
            ''If Customer_CFL("3", Me.SCompany.Text, sErrdesc) <> RTN_SUCCESS Then
            ''    Throw New ArgumentException(sErrdesc)
