...
Module modCommon
    ...
    Public Function GetSystemIntializeInfo(ByRef oCompDef As CompanyDefault, ByRef sErrDesc As String) As Long
        ...
        Try
            ...
            If Not String.IsNullOrEmpty(ConfigurationManager.AppSettings("SSL")) Then
                oCompDef.sSSL = ConfigurationManager.AppSettings("SSL")
            End If
    ...
    Public Function SendEmailNotification(ByVal sfileName As String, _
        ...
        Try
            ...
            If p_oCompDef.sSSL.ToUpper = "YES" Then
