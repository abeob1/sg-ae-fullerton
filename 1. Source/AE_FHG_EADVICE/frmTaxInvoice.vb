        ...
        Try
          ...
          Me.txtBpCode.Text <> String.Empty Then
            ...
            sSQL = "SELECT T1.""E_Mail"",T0.""DocEntry"",T0.""CardCode"",T0.""DocNum"",T0.""CardName"", T0.""DocDate"" " & _
                    " FROM " & """" & Me.SCompany.Text & """" & ".OINV T0  LEFT OUTER JOIN " & """" & Me.SCompany.Text & """" & ".OCRD T1" & _
                    " ON T0.""CardCode""= T1.""CardCode"" INNER JOIN " & """" & Me.SCompany.Text & """" & ".INV1 T2" & _
                    " ON T2.""DocEntry""= T0.""DocEntry"" INNER JOIN " & """" & Me.SCompany.Text & """" & ".ORDR T3" & _
                    " ON T3.""DocEntry""= T2.""BaseEntry"" LEFT OUTER JOIN " & """" & Me.SCompany.Text & """" & ".OITM T4" & _
                    " ON T4.""ItemCode""= T2.""ItemCode"" LEFT OUTER JOIN " & """" & Me.SCompany.Text & """" & ".OCRY T5" & _
                    " ON T5.""Code""= T1.""Country"" LEFT OUTER JOIN " & """" & Me.SCompany.Text & """" & ".OCPR T6" & _
                    " ON T6.""CntctCode""= T0.""CntctCode"" LEFT OUTER JOIN " & """" & Me.SCompany.Text & """" & ".""@AI_DOCTOR_EXAMINER"" T7" & _
                    " ON T0.""U_AI_EXAMINER""= T7.""Code"" LEFT OUTER JOIN " & """" & Me.SCompany.Text & """" & ".OCTG T8" & _
                    " ON T8.""GroupNum""= T0.""GroupNum"" WHERE T0.""CANCELED"" <>'Y' "
